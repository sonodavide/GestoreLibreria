...
import com.sonodavide.gestorelibreria.service.BookDtoOrderStrategy.PublisherBookDtoOrderStrategy;
...
class PublisherBookDtoOrderStrategyTest {
    PublisherBookDtoOrderStrategy strategy;
    ...
    public void testSorting() {
        strategy = new PublisherBookDtoOrderStrategy();
        ...
        assertEquals(books.get(2), res.get(1));
    }
