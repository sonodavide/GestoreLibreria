...
class GenresBookDtoOrderStrategyTest {
    GenresBookDtoOrderStrategy strategy;
    ...
    public void testSort(){
        strategy = new GenresBookDtoOrderStrategy();
        ...
        assertEquals(books.get(3), res.get(3));
    ...
    public void testSortedReversed(){
        ...
        assertEquals(books.get(3), res.get(0));
    }
}